...
inline void update_mtopi() {
  ...
  set_iprios_sort(mtopi_gather, cpu.MIpriosSort, cpu.MIprios_rdata, IRQ_MEIP, cpu.fromaia.mtopei);
...
inline void update_stopi() {
  ...
  set_iprios_sort(stopi_gather, cpu.SIpriosSort, cpu.SIprios_rdata, IRQ_SEIP, cpu.fromaia.stopei);
